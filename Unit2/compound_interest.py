...
def displayRetireWMonthsAndRatesWLabels(monthlies, rates, terms):
    plt.figure('retireBothwLabels')
    plt.clf()
    plt.xlim(30*12, 40*12)
    monthLabels = ['r', 'b', 'g', 'k']
    rateLabels = ['-', 'o', '-']
...
displayRetireWMonthsAndRates([500, 700, 900, 1100], [0.3, .05, .07], 40*12)
displayRetireWMonthsAndRatesWLabels([500, 700, 900, 1100], [0.3, .05, .07], 40*12)
